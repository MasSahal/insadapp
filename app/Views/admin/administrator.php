...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Akun Administrator</h1>
    <a href="<?= base_url('/admin/account/generate-administrator') ?>" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Laporan</a>
</div>
...
<div class="row">
    <div class="col-md-4">
            ...
            <?php foreach ($edit as $e) :; ?>
                <div class="card shadow border-left-info mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Akun Administrator</h6>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('/admin/account/administrator/insert-edit') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="pass" name="pass" id="pass" value="<?= $e->password; ?>" required class="form-control" readonly>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url('/admin/account/administrator/insert-edit-pw') ?>" method="post">
                                    <div class="form-group">
                                        <label for="pass">Password</label>
        ...
        <?php } else {; ?>
            <div class="card shadow border-left-info mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Akun Administrator</h6>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('/admin/account/administrator/insert') ?>" method="post">
                        <div class="form-group">
                            <label for="nama">Nama</label>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($admin as $a) {; ?>
                                <tr>
                                    ...
                                    <td><?= $a->username ?></td>
                                    <td>
                                        <?php if (isset($_GET['edit']) && $_GET['edit'] == $a->id_petugas) {; ?>
                                        ...
                                        <?php } else { ?>
                                            <a href="<?= base_url('/admin/account/administrator/?edit=' . $a->id_petugas) ?>" class="text-warning btn">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" data-toggle="modal" data-target="#hapus_<?= $a->id_petugas ?>" class="text-danger btn">
                                                <i class="fa fa-trash" aria-hidden="true"></i>
                                            </button>
                                        <?php } ?>
                                    </td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center">
                                                    <h5><?= "Yakin ingin menghapus akun " . $a->nama_petugas . " ?"; ?></h5>
                                                    <br>
                                                    <button type="button" class="btn btn-sm btn-outline-dark" data-dismiss="modal">Cancel</button>
                                                    <a href="<?= base_url('/admin/account/administrator/' . $a->id_petugas . '/delete') ?>" class="btn btn-sm btn-danger">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
