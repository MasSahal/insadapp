...
<head>
    ...
    <meta name="description" content="aplikasiproduk">
    <meta name="author" content="Usamah">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Isadapp <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('/admin/penyewaan') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#uang" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-money-bill-alt fa-fw"></i>
                    <span>Keuangan</span>
                </a>
                <div id="uang" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Keuangan</h6>
                        <a class="collapse-item" href="<?= base_url('/accounting/neraca-saldo') ?>">Neraca Saldo</a>
                        <a class="collapse-item" href="<?= base_url('/accounting/transaksi') ?>">Transaksi</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="pengguna" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('/admin/account/administrator') ?>">Admin</a>
                        <a class="collapse-item" href="<?= base_url('/admin/account/pelanggan') ?>">Pelanggan</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <a href="http://massahal.my.id" target="_blank" rel="noopener noreferrer">Mas Sahal</a> 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?= base_url('/public') ?>/vendor/jquery/jquery-ui.js"></script>
