...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
        <div class="container">
            <a class="navbar-brand" href="#">InSadAPP.web</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 class="mt-5">Ini adalah Konten</h1>
                <p class="lead">Ini jga sama tpi tulisannya kecil</p>
                <ul class="list-unstyled">
                    <li>Text Copyright @Classified874</li>
                </ul>
            </div>
        </div>
    </div>
